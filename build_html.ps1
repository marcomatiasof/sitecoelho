...
W '      <span class="logo-sub">por Exto Incorporadora</span>'
W '    </div>'
...
W '      <a href="tel:+551147102220" class="btn-phone">&#9742; (11) 4710-2220</a>'
...
W '  <div class="container">'
W '    <span class="section-label reveal">Portf&#243;lio Exto</span>'
...
W '        <a href="https://www.instagram.com/extoempreendimentos" target="_blank" rel="noopener" class="fs-link">IG</a>'
W '        <a href="https://www.facebook.com/ExtoIncorporadora" target="_blank" rel="noopener" class="fs-link">FB</a>'
W '        <a href="https://www.youtube.com/channel/UC26GJMjgSI0KpFzoB1yvnww" target="_blank" rel="noopener" class="fs-link">YT</a>'
W '      </div>'
W '    </div>'
W '    <div class="footer-col"><h4>Empreendimento</h4><ul>'
W '      <li><a href="#sobre">Conceito</a></li><li><a href="#lazer">&#193;reas de Lazer</a></li>'
W '      <li><a href="#ambientes">Ambientes</a></li><li><a href="#plantas">Plantas</a></li>'
W '      <li><a href="#tour">Tour Virtual 360&#176;</a></li>'
W '    </ul></div>'
W '    <div class="footer-col"><h4>Exto Incorporadora</h4><ul>'
W '      <li><a href="https://www.exto.com.br" target="_blank" rel="noopener">Quem somos</a></li>'
W '      <li><a href="https://www.exto.com.br/empreendimentos" target="_blank" rel="noopener">Empreendimentos</a></li>'
W '      <li><a href="#outros">Portf&#243;lio</a></li>'
W '    </ul></div>'
W '    <div class="footer-col"><h4>Contato</h4><ul>'
W '      <li><a href="tel:+551147102220">Vendas: (11) 4710-2220</a></li>'
W '      <li><a href="tel:+551137249500">Escrit&#243;rio: (11) 3724-9500</a></li>'
W '      <li>R. Min. Nelson Hungria, 400<br>Cidade Jardim &#8211; SP</li>'
W '    </ul>'
W '    <button class="btn-footer-cta" onclick="openModal(''modal-visita'')">Agendar Visita</button>'
W '    </div>'
W '  </div></div></div>'
W '  <div class="footer-bottom"><div class="container">'
W '    <p class="footer-disclaimer">* Os custos de courrier e concierge ser&#227;o arcados pelas incorporadoras durante seis meses a partir da AGI. Manuten&#231;&#227;o da quadra de saibro com custos arcados durante um ano a partir da entrega das chaves. Informa&#231;&#245;es preliminares sujeitas a modifica&#231;&#245;es. Imagens meramente ilustrativas.</p>'
W '    <div class="footer-legal"><span>&#169; 2026 Exto Incorpora&#231;&#227;o e Constru&#231;&#227;o. Todos os direitos reservados.</span><button onclick="openModal(''modal-privacidade'')" class="link-privacy-footer">Pol&#237;tica de Privacidade</button></div>'
W '  </div></div>'
W '</footer>'
...
# MODAIS
W '<div class="modal-overlay" id="modal-visita" onclick="closeModalOutside(event,this)">'
W '  <div class="modal-box"><button class="modal-close" onclick="closeModal(''modal-visita'')">&#10005;</button>'
...
W '      <div class="form-group"><label>Nome *</label><input type="text" placeholder="Seu nome completo" required></div>'
W '      <div class="form-row two"><div class="form-group"><label>E-mail *</label><input type="email" placeholder="seu@email.com" required></div><div class="form-group"><label>WhatsApp *</label><input type="tel" placeholder="(11) 99999-9999" required></div></div>'
W '      <div class="form-group"><label>Tipologia</label><select><option>Harmonie 185m&#178;</option><option>Harmonie 215m&#178;</option><option>Harmonie 248m&#178;</option><option>Lumi&#232;re 355m&#178;</option></select></div>'
...
W '<div class="modal-overlay" id="modal-ficha" onclick="closeModalOutside(event,this)">'
W '  <div class="modal-box modal-wide"><button class="modal-close" onclick="closeModal(''modal-ficha'')">&#10005;</button>'
...
W '      <div class="ficha-item"><strong>Incorporadora</strong><span>Exto Incorpora&#231;&#227;o e Constru&#231;&#227;o</span></div>'
...
W '<div class="modal-overlay" id="modal-video" onclick="closeModalOutside(event,this)">'
W '  <div class="modal-box modal-video"><button class="modal-close" onclick="closeModal(''modal-video'')">&#10005;</button>'
W '    <div class="video-embed-wrap"><iframe id="yt-iframe" src="" data-src="https://www.youtube.com/embed?listType=user_uploads&list=UC26GJMjgSI0KpFzoB1yvnww&autoplay=1" title="Video Chateau Jardin" frameborder="0" allow="accelerometer;autoplay;clipboard-write;encrypted-media;gyroscope;picture-in-picture" allowfullscreen></iframe></div>'
W '  </div>'
W '</div>'

W '<div class="modal-overlay" id="modal-wpp" onclick="closeModalOutside(event,this)">'
W '  <div class="modal-box modal-compact"><button class="modal-close" onclick="closeModal(''modal-wpp'')">&#10005;</button>'
...
W '    </form>'
W '    <a href="https://wa.me/551147102220?text=Ol%C3%A1%21+Tenho+interesse+no+Ch%C3%A2teau+Jardin." target="_blank" rel="noopener" class="wpp-direct">Abrir WhatsApp diretamente &#8594;</a>'
W '  </div>'
W '</div>'

W '<div class="modal-overlay" id="modal-call" onclick="closeModalOutside(event,this)">'
W '  <div class="modal-box modal-compact"><button class="modal-close" onclick="closeModal(''modal-call'')">&#10005;</button>'
W '    <div class="modal-header"><h2>Fale com um Especialista</h2><p>Ligue agora ou solicite retorno:</p></div>'
W '    <div class="call-numbers">'
W '      <a href="tel:+551147102220" class="call-link">&#9742; Vendas: (11) 4710-2220</a>'
W '      <a href="tel:+551137249500" class="call-link">&#9742; Escrit&#243;rio: (11) 3724-9500</a>'
W '    </div>'
W '    <hr class="modal-divider">'
W '    <form onsubmit="handleSubmit(event,''ligacao'')">'
W '      <div class="form-group"><label>Deixe seu n&#250;mero para retorno:</label><input type="tel" placeholder="(11) 99999-9999" required></div>'
W '      <div class="form-group"><input type="text" placeholder="Seu nome"></div>'
W '      <button type="submit" class="btn-submit">Solicitar Retorno de Chamada</button>'
W '    </form>'
W '  </div>'
W '</div>'

W '<div class="modal-overlay" id="modal-lazer" onclick="closeModalOutside(event,this)">'
W '  <div class="modal-box modal-lazer-detail"><button class="modal-close" onclick="closeModal(''modal-lazer'')">&#10005;</button>'
W '    <div class="lazer-modal-img"><img id="lazerModalImg" src="" alt=""></div>'
W '    <div class="lazer-modal-info">'
W '      <span class="modal-label" id="lazerModalCat"></span>'
W '      <h2 id="lazerModalTitle"></h2>'
W '      <p id="lazerModalDesc"></p>'
W '      <button class="btn-primary" onclick="closeModal(''modal-lazer'');openModal(''modal-visita'')">Quero Conhecer Presencialmente</button>'
W '    </div>'
W '  </div>'
W '</div>'

W '<div class="modal-overlay" id="modal-planta" onclick="closeModalOutside(event,this)">'
W '  <div class="modal-box modal-planta-detail"><button class="modal-close" onclick="closeModal(''modal-planta'')">&#10005;</button>'
...
W '<div class="modal-overlay" id="modal-privacidade" onclick="closeModalOutside(event,this)">'
W '  <div class="modal-box modal-wide scrollable"><button class="modal-close" onclick="closeModal(''modal-privacidade'')">&#10005;</button>'
W '    <div class="modal-header"><h2>Pol&#237;tica de Privacidade</h2></div>'
W '    <div class="privacy-content">'
W '      <p>A EXTO Incorpora&#231;&#227;o e Constru&#231;&#227;o respeita a sua privacidade e est&#225; comprometida com a prote&#231;&#227;o de seus dados pessoais, em conformidade com a Lei Geral de Prote&#231;&#227;o de Dados Pessoais (Lei n&#186; 13.709/2018 &#8211; LGPD).</p>'
W '      <h4>Dados Coletados</h4><p>Coletamos nome, e-mail e telefone exclusivamente para fins de contato comercial relacionado aos empreendimentos da Exto.</p>'
W '      <h4>Finalidade do Tratamento</h4><p>Contato comercial, agendamento de visitas, envio de informa&#231;&#245;es sobre lan&#231;amentos e estudo de mercado.</p>'
W '      <h4>Seus Direitos</h4><p>Solicite acesso, corre&#231;&#227;o ou exclus&#227;o dos seus dados pelo e-mail: privacidade@exto.com.br</p>'
W '      <h4>Contato DPO</h4><p>privacidade@exto.com.br | (11) 3724-9500 | R. Min. Nelson Hungria, 400 &#8211; Cidade Jardim, SP</p>'
W '    </div>'
W '  </div>'
W '</div>'
